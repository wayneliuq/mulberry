# Adding New Game Mods With Agentic AI

Use this prompt pattern when asking an AI agent to add a new game mode to Mulberry.

## Prompt Template

```text
Add a new game mode to Mulberry called "<GAME MOD NAME>".

Follow `docs/implementation-roadmap.md` and `docs/rules.md`.
...
Requirements for this game mode:
...
- keep existing game modes working
...
- `src/features/game-types/<newGameMod>.ts`
- `src/features/game-types/<newGameMod>.test.ts`
...
- The new game mode must fit the existing shared game-type architecture.
...
- State how ties, remainders, or uneven distributions should work.
