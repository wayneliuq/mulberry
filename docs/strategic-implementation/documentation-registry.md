This registry tracks implementation-facing documentation used by strategic implementation workflows. Keep entries concise and current so downstream planning can reference authoritative docs without rediscovery.

| Path | Covers | Last Updated | Update Trigger | Owning Area |
| --- | --- | --- | --- | --- |
| `docs/game-type-basketball.md` | Basketball scoring model, seasons, dashboard behavior, OpenSkill replay, team presets, and reproducibility constraints. | 2026-06-25 | Any change to basketball round metadata, season boundaries, scoring logic, dashboard metrics, leaderboard filters, team presets, or historical replay rules. | basketball |
